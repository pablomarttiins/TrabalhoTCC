...
CREATE TABLE IF NOT EXISTS `maxfitt`.`fichatreino` (
  ...
  `fichaFinalizada` INT(3) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `maxfitt`.`fichatreino_aluno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maxfitt`.`fichatreino_aluno` (
  `codFichaTreino` INT(11) NOT NULL,
  `codAluno` INT(11) NOT NULL,
  PRIMARY KEY (`codFichaTreino`, `codAluno`),
  INDEX `fk_fichatreino_has_aluno_aluno1_idx` (`codAluno` ASC),
  INDEX `fk_fichatreino_has_aluno_fichatreino1_idx` (`codFichaTreino` ASC),
  CONSTRAINT `fk_fichatreino_has_aluno_aluno1`
    FOREIGN KEY (`codAluno`)
    REFERENCES `maxfitt`.`aluno` (`codAluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fichatreino_has_aluno_fichatreino1`
