<div class="container">
    <div class="col-xs-12 col-md-12">
        <form action="<?= base_url() ?>Usuario_controller/inserir" method="post" style="padding-top: 100px">
           
            <div class="col-xs-12 col-md-12"> 

                <div class="col-xs-5 col-md-5">
                    <input type="hidden" class="form-control" id="codAluno" name="codAluno" value="<?= $codAluno; ?>" placeholder="<?= $codAluno; ?>" readonly> 
                </div>
