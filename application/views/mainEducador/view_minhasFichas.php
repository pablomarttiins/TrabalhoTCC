...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="col-md-10">
        <h1 class="page-header">Minhas Fichas de Treino Cadastradas</h1>
    </div>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <?php foreach($fichas as $linha) { ?>
            <tr> 
                ...
                <td><a href="<?= base_url('Educador_controller/fichaCompleta/'.$linha->codFichaTreino) ?>" target="_blank" class="btn btn-success">Expandir Ficha</td> 
            </tr>
        <?php } ?>
        </tbody>
        </table>
