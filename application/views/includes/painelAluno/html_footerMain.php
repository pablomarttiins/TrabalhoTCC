<!-- Footer -->
	<footer id="footer" class="footer">
		...
		<!-- Copyright -->
		<p class="copyright normal">© 2016 <span class="colored">MaxFitness.</span> Todos os direitos reservados.</p>
	</footer><!-- End Footer -->
	...
	<script type="text/javascript" src="<?= base_url(); ?>assets/js/jquery.superslides.js"></script>
	...
	<script type="text/javascript" src="<?= base_url(); ?>assets/js/jquery.slabtext.js"></script>
